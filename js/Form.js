class Form {
  ...
  constructor() {
    ...
    this.line4=createElement('h1');
    this.next5=createButton('h1');
    this.thirdlevel2=createElement('h1');
    this.ques2=createElement('h1');
    this.ans5=createInput('name');
    this.impot5=createButton('ENTER');
    this.line5=createElement('h1');
    this.next6=createButton('h1');
    this.thirdlevel3=createElement('h1');
    this.ques3=createElement('h1');
    this.ans6=createInput('name');
    this.impot6=createButton('ENTER');
    this.line6=createElement('h1');
    this.next7=createButton('h1');
...
gameState=1;
  ...
  this.impot2.position(displayWidth/2-45,displayHeight/1-300);
   ...
   this.information3.position(displayWidth/2-200,displayHeight/10);
    ...
    this.line4.html("AMAZING!");
   this.line4.position(displayWidth/2 -95, displayHeight/25);

   this.next5.html("NEXT PART");
   this.next5.position(displayWidth/2-40,displayHeight/4);
    ...
    this.next5.mousePressed(()=>{
      ...
      this.thirdlevel2.html("Third level-second part");
      this.thirdlevel2.position(displayWidth/2 -180, displayHeight/19);

      this.ques2.html("I Have Teeth But Can't Eat");
      this.ques2.position(displayWidth/2-200,displayHeight/7);
  
      this.ans5.position(displayWidth/2 - 100, displayHeight/4);
      this.impot5.position(displayWidth/2-45,displayHeight/3);

    })

    this.impot5.mousePressed(()=>{

      gameState=6;

      score = score + 50;

      this.thirdlevel2.hide();
      this.ques2.hide();
      this.ans5.hide();
      this.impot5.hide();

      this.line5.html("FABOLOUS!");
      this.line5.position(displayWidth/2 -95, displayHeight/25);
   
      this.next6.html("NEXT PART");
      this.next6.position(displayWidth/2-40,displayHeight/4);
    ...
    this.next6.mousePressed(()=>{
      ...
      this.thirdlevel3.html("Third level-third part");
      this.thirdlevel2.position(displayWidth/2 -180, displayHeight/19);

      this.ques3.html("I Have All The Knowledge You Have,But I'am So Small,You Can Hold Me In Your Fist.What Am I ?");
      this.ques3.position(displayWidth/2-700,displayHeight/9);
  
      this.ans6.position(displayWidth/2 - 100, displayHeight/4);
      this.impot6.position(displayWidth/2-45,displayHeight/3);

    })

    this.impot6.mousePressed(()=>{

      gameState=7;

      score = score + 50;

      this.thirdlevel3.hide();
      this.ques3.hide();
      this.ans6.hide();
      this.impot6.hide();

      this.line6.html("GREAT!");
      this.line6.position(displayWidth/2 -80, displayHeight/25);
   
      this.next7.html("NEXT");
      this.next7.position(displayWidth/2-40,displayHeight/7);
  ...
  /* static getPlayerInfo(){
    var AnsInfoRef = database.ref('level1');
   AnsInfoRef.on("value",(data)=>{
     // allPlayers = data.val();
    })
  }
 */
